    ...
    public partial class Cost : Form
    {
      ...
      public  void fill_combo()
        ...
        private void printDocument1_PrintPage_1(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Per pice price", new Font("Arial", 12, FontStyle.Bold), Brushes.Black, new Point(250, 200));
            ...
            e.Graphics.DrawString("Total Cost = " + textBox4.Text, new Font("Arial", 12, FontStyle.Bold), Brushes.Black, new Point(600, y + 75));
        ...
        private void button8_Click_1(object sender, EventArgs e)
        {
            ...
            if (textBox10.Text != "" & textBox4.Text != "")
            {

                con.Open();
                sc.CommandText = "insert into SM (DT,CNM,AMNT) values ('" + textBox10.Text + "','" + textBox8.Text + "','" + textBox4.Text + "')";
                sc.ExecuteNonQuery();
